...
Сумму можно посчитать встроенной функцией <tt>sum()</tt>, которая складывает разные типы данных, в том числе и массивы. Но лучше воспользоваться одноимённым методом <tt>название_массива.sum()</tt>, он делает то же самое, но быстрее.
</details>
